//
// Created by Charles on 2020/03/24.
//
#include <jni.h>
#include <string.h>
#include <stdio.h>
...
Java_com_charlezz_blur_StackBlurNative_00024Companion_blur(JNIEnv *env, jobject thiz,
                                                           jobject bitmap_out, jint radius,
                                                           jint thread_count, jint thread_index,
                                                           jint round) {
    // Properties
    ...
    stackblurJob((unsigned char*)pixelsOut, w, h, radius, thread_count, thread_index, round);
